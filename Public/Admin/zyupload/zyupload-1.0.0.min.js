	...
	$.fn.zyPopup = function(options, param) {
		...
		return this
				.each(function() {
					var para = {};
					var self = this;
					var zoom = "", zoomContent = "", zoomedIn = false, openedImage = null, windowWidth = "", windowHeight = "";
					var tailorVal = {};
					var defaults = {
						src : "",
						index : 0,
					...
					this.createHtml = function() {
						...
						$("body")
								.append(
										'<div id="zoom"><a class="finish"></a><a class="close"></a><div class="content loading"></div></div>');
						zoom = $("#zoom").hide(),
								zoomContent = $("#zoom .content"),
								zoomedIn = false, openedImage = null,
								windowWidth = $(window).width(),
								windowHeight = $(window).height()
					};
					this.openPopup = function() {
						var self = this;
						var image = $(new Image()).attr("id", "tailorImg")
								.hide();
						...
						function render() {
							var image = $(this), borderWidth = parseInt(zoomContent
									.css("borderLeftWidth")), maxImageWidth = windowWidth
									- (borderWidth * 2), maxImageHeight = windowHeight
									- (borderWidth * 2), imageWidth = image
									.width(), imageHeight = image.height();
							if (imageWidth == zoomContent.width()
									&& imageWidth <= maxImageWidth
									&& imageHeight == zoomContent.height()
				...
				.each(function() {
					...
					this.createHtml = function() {
						...
						if (para.dragDrop) {
							...
							html += '						<div class="uploadImg" style="width:'
									+ imgWidth + 'px">';
							html += '							<img class="upload_image" src="zyupload/skins/images/add_img.png" style="width:expression(this.width > '
									+ imgWidth
									+ " ? "
									+ imgWidth
									+ 'px : this.width)" />';
					...
					this.funDisposePreviewHtml = function(file, e) {
						...
						if (file.type.indexOf("image") == 0) {
							...
							html += '	<div class="file_bar">';
							html += '		<div style="padding:5px;">';
							html += '			<p class="file_name">' + file.name
									+ "</p>";
							html += delHtml;
							html += "		</div>";
							html += "	</div>";
