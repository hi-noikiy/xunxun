var ZYFILE = {
	fileInput : null,	//表file控件元素。
	uploadInput : null,		//提交的按钮元素。
	dragDrop : null,	//表拖放感应区域元素
	url : "",			//表示文件ajax上传的地址
	uploadFile : [],
	lastUploadFile : [],
	perUploadFile : [],
				...
				.each(function() {
					...
					this.createHtml = function() {
						...
						if (para.dragDrop) {
							...
							html += '<form id="uploadForm" action="'+ para.url+ '" method="post" enctype="multipart/form-data">';
							// html += 'aaaaaaaa6';
							// html += '<input type="text" class="Name-input" name="titles"/>';
							html += '	<div class="upload_box">';
							...
							html += '						<div class="uploadImg" style="width:'
									+ imgWidth + 'px">';
							html += '							<img class="upload_image" src="upload/Home/zyupload/skins/images/add_img.png" style="width:expression(this.width > '
									+ imgWidth
									+ " ? "
									+ imgWidth
									+ 'px : this.width)" />';
					...
					this.createCorePlug = function() {
						var params = {
							...
							url : $("#uploadForm").attr("action"),   //ajax表单上传地址(取得是action地址)
							filterFile : function(files) {
							...
							onProgress : function(file, loaded, total) {
								var eleProgress = $("#uploadProgress_"
										+ file.index), percent = (loaded/ total * 100).toFixed(2)
										+ "%";
