...
class SunrankController extends Controller {

    public function sunlist(){
        $selfUid = 0;
        $hava_res = 1;
        $list = array();
        $info = array();
        ...
        $Member = D('Api/Member');
        $where['addtime'] = array(array('egt','2019-08-19 00:00:00'),array('lt','2019-08-26 00:00:00'));
...
$where['touid'] = array('not in','1000009,1012582');
        ...
        if (empty($result)) {
            ...
            $whereLike['addtime'] = array(array('egt','2019-08-19 00:00:00'),array('lt','2019-08-26 00:00:00'));
