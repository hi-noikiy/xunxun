...
//            $data = RoomManagerService::getInstance()->getList();
            ...
            foreach($dataes as $key=>$value){
                $dataes[$key]['avatar'] = $value['avatar']?C("APP_URL").$value['avatar']:'';
                $dataes[$key]['pretty_avatar'] = $value['avatar']?C("APP_URL").$value['pretty_avatar']:'';
                $dataes[$key]['pretty_avatar_svga'] = $value['avatar']?C("APP_URL").$value['pretty_avatar_svga']:'';
