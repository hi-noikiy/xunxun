...
class ApplePayController extends BaseController {
  ...
  /*  private $receipt;
     ...
     */
    public function getreceiptdata($token,$receipt,$rmb,$signature,$user_id){
        ...
        try{
            ...
            if($data_repose['user_id'] !== $user_id){
                E("此用户异常数据",2000);
            }
            //$receipt = $this->receipt;
            $endpoint = 'https://sandbox.itunes.apple.com/verifyReceipt';       //沙盒模式
//            $isSandbox = false;//如果是沙盒模式，请求苹果测试服务器,反之，请求苹果正式的服务器
//            if ($isSandbox) {
//                $endpoint = 'https://sandbox.itunes.apple.com/verifyReceipt';       //沙盒模式
//            }
//            else {
...
//            }
            ...
            curl_close($ch);
            //$response = '{"receipt":{"receipt_type":"ProductionSandbox","adam_id":0,"app_item_id":0,"bundle_id":"com.xinyue.mua","application_version":"1","download_id":0,"version_external_identifier":0,"receipt_creation_date":"2019-07-12 04:52:16 Etc\/GMT","receipt_creation_date_ms":"1562907136000","receipt_creation_date_pst":"2019-07-11 21:52:16 America\/Los_Angeles","request_date":"2019-07-12 10:23:25 Etc\/GMT","request_date_ms":"1562927005434","request_date_pst":"2019-07-12 03:23:25 America\/Los_Angeles","original_purchase_date":"2013-08-01 07:00:00 Etc\/GMT","original_purchase_date_ms":"1375340400000","original_purchase_date_pst":"2013-08-01 00:00:00 America\/Los_Angeles","original_application_version":"1.0","in_app":[{"quantity":"1","product_id":"com.xinyue.mua10010","transaction_id":"1000000546194431","original_transaction_id":"1000000546194431","purchase_date":"2019-07-12 04:52:16 Etc\/GMT","purchase_date_ms":"1562907136000","purchase_date_pst":"2019-07-11 21:52:16 America\/Los_Angeles","original_purchase_date":"2019-07-12 04:52:16 Etc\/GMT","original_purchase_date_ms":"1562907136000","original_purchase_date_pst":"2019-07-11 21:52:16 America\/Los_Angeles","is_trial_period":"false"}]},"status":0,"environment":"Sandbox"}';
...
//            var_dump($count1);die();
            ...
            //生成支付订单
            //开启事务并且生成支付订单
//            $coin = self::$list[$data['rmb']]?self::$list[$data['rmb']]["diamond"]:0;
//            $coin = D('chargeios')->getOneByIdField($data['rmb']);
//            var_dump($coin);die();
...
//            var_dump($chargedetail);die();
            ...
            //3.增加用户的虚拟币
            $member = M('member')->where(array("id"=>$user_id))->setInc('totalcoin',$coin);
//            echo M('chargedetail')->getLastSql();die();
