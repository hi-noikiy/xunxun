...
//------------------------------------------------------用户体系	
 ...
 //    public function __construct() {
	// 	$this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : 'YXA6CcMB0EbpEemqFg3N6fL2lA';
	// 	$this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : 'YXA6n7KX2Ec4haWEaYBFKBP4cdpK07Q';
	// 	$this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : '1103190315168034';
	// 	$this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : 'mua';
	...
	public function __construct() {
		$hxconf = C('HXCONF');
		$this->client_id = $hxconf['client_id'];
		$this->client_secret = $hxconf['client_secret'];
		$this->org_name = $hxconf['org_name'];
		$this->app_name = $hxconf['app_name'];
		if (! empty ( $this->org_name ) && ! empty ( $this->app_name )) {
			$this->url = 'https://a1.easemob.com/' . $this->org_name . '/' . $this->app_name . '/';
		}
	}
