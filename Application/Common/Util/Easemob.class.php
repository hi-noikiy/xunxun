...
class Easemob
{
    ...
    private $app_key = '1103190315168034#mua';     //应用标识appkey
    private $client_id = 'YXA6CcMB0EbpEemqFg3N6fL2lA';     //client_id
    private $client_secret = 'YXA6n7KX2Ec4haWEaYBFKBP4cdpK07Q';      //client_secret
    private $url = "https://a1.easemob.com/1103190315168034/mua";      //应用标识号
    /*
     * 获取APP管理员Token
     */
...
/*$rs = new Hxcall();
// 注册的用户
$data = $rs->hx_register('2', '123456', '15210974319' );
echo "<pre>";
var_dump($data);
echo "</pre>";*/
//echo $rs->hx_register('qwerasd', 'qazwsx', '福州123' );
// 给IM用户的添加好友
// echo $rs->hx_contacts('2', '1');
/* 发送文本消息 */
